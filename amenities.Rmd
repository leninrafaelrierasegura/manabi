...
Go to this [file](https://github.com/leninrafaelrierasegura/manabi/blob/main/amenities.R)  to see how that is done.

---

By the way, the layers names are:
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("Area of the head of the administrative units.")}
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("Small towns and villages, apparently.")}
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("Educational buildings.")}
EDIFICIO_EDUCACIONAL <- readRDS("clean_data/amn_EDIFICIO_EDUCACIONAL.RDS")
mapview(
    EDIFICIO_EDUCACIONAL,
...
Here we can see the `ESTABLECIMIENTO DE SALUD` amenities.

```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("Hospital buildings.")}
ESTABLECIMIENTO_DE_SALUD <- readRDS("clean_data/amn_ESTABLECIMIENTO_DE_SALUD.RDS")
mapview(
