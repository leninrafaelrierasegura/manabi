...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("This shows the polygon that delimits the area of interest. Click on the region to see more details.")}
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("This shows the region of interest at the country level. Click on the region to see more details.")}
mapview(
  gadm41_ECU_country,
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("This shows the region of interest at the province level. Click on the region to see more details.")}
mapview(
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("This shows the region of interest at the canton level. Click on the region to see more details.")}
mapview(
  gadm41_ECU_cantons,
...
```{r, out.width = "100%", fig.height = 12, fig.cap = captioner("This shows the region of interest at the parish level. Click on the region to see more details.")}
mapview(
  gadm41_ECU_parishes,
